              ...
              <div className="info-card">
                ...
                <div className="info-items">
                  <div className="info-item">
                    ...
                    <div className="info-content">
                      <h3>Email Us</h3>
                      <a href="mailto:www.seraune.com@gmail.com">www.seraune.com@gmail.com</a>
                    </div>
                  </div>
                  ...
                  <div className="info-item">
                    ...
                    <div className="info-content">
                      <h3>Call Us</h3>
                      <a href="tel:+1 (469) 739-7673">+1 (469) 739-7673</a>
                    </div>
                  </div>
                  ...
                  <div className="info-item">
                    ...
                    <div className="info-content">
                      <h3>Visit Us</h3>
                      <p>5845 43rd Avenues Woodside New York 11377</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="social-links">
                  ...
                  <div className="social-icons">
                    <a href="https://x.com/i/flow/login?redirect_after_login=%2Fseraune" target="_blank" rel="noopener noreferrer" className="social-icon twitter">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/>
                      </svg>
                    </a>
                    <a href="https://www.facebook.com/people/Seraune/61572012682741/?mibextid=wwXIfr&rdid=ySPGH2RJizzv9x1t&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1HDnzmLq4G%2F%3Fmibextid%3DwwXIfr" target="_blank" rel="noopener noreferrer" className="social-icon facebook">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <a href="https://www.instagram.com/seraune_dot_com/?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw%3D%3D#" target="_blank" rel="noopener noreferrer" className="social-icon instagram">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
